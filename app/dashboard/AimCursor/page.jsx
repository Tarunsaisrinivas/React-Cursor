      ...
      <div className="w-full max-w-7xl mx-auto">
        ...
        <Tabs defaultValue="demo" className="w-full">
            ...
            <Card className="bg-white/50 dark:bg-[#171717]/50 backdrop-blur-sm border-2">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-lg">
                  Move your cursor around this area to see the aim effect
                </CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="component" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle className="text-xl">AimCursor.jsx</CardTitle>
                <CardDescription>
          ...
          <TabsContent value="props" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  You can customize the component using the following prop.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <CodeSnippetViewer
                ...
                <div className="mt-6 grid gap-4 md:grid-cols-2">
                  <div className="border rounded-xl p-4 bg-[#171717] border-purple-400 shadow-md">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Sets the color of the aim ring, dot, and crosshair.
                      Accepts any valid CSS color string (e.g.,{" "}
                      <code>#AD46FF</code>,<code>red</code>).
                    </p>
                  </div>
                </div>
              </CardContent>
