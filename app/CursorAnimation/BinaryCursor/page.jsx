              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-12 gap-6">
                  <div className="text-center lg:text-left space-y-4">
                      ...
                      <p className="text-muted-foreground text-xl max-w-2xl">
                          Move your mouse around to see the binary particle
                          effect in action!
                      </p>
                  </div>
                                  ...
                                  <div className="text-center space-y-6 z-10">
                                      ...
                                      <div className="space-y-2">
                                          ...
                                          <p className="text-violet-300 text-lg">
                                              Binary particles will follow your
                                              cursor
                                          </p>
                                      </div>
                                  </div>
                      ...
                      <Card>
                          <CardHeader className="flex flex-row items-center justify-between">
                              <div>
                                  ...
                                  <CardDescription>
                                      How to implement the binary cursor in your
                                      app
                                  </CardDescription>
                              </div>
                          </CardHeader>
                          ...
                          <CardContent>
                              ...
                              <div className="mt-6 space-y-4">
                                  <div className="grid gap-4 md:grid-cols-2">
                                      <div className="border rounded-xl p-4 bg-[#171717] backdrop-blur-sm border-purple-400 shadow-md">
                                          ...
                                          <p className="text-sm text-muted-foreground">
                                              The color of the binary particles.
                                      ...
                                      <div className="border rounded-xl p-4 bg-[#171717] backdrop-blur-sm border-purple-400 shadow-md">
                                          ...
                                          <p className="text-sm text-muted-foreground">
                                              Font size of the binary characters
                                              in pixels.
                                          </p>
                                      </div>
                                      <div className="border rounded-xl p-4 bg-[#171717] backdrop-blur-sm border-purple-400 shadow-md">
                                          ...
                                          <p className="text-sm text-muted-foreground">
                                              Number of particles generated per
                                              emission.
                                          </p>
                                      </div>
                                      <div className="border rounded-xl p-4 bg-[#171717] backdrop-blur-sm border-purple-400 shadow-md">
                                          ...
                                          <p className="text-sm text-muted-foreground">
                                              How far particles spread from the
                                              cursor position.
                                          </p>
                                      </div>
                                      <div className="border rounded-xl p-4 bg-[#171717] backdrop-blur-sm border-purple-400 shadow-md">
                                      ...
                                      <div className="border rounded-xl p-4 bg-[#171717] backdrop-blur-sm border-purple-400 shadow-md">
                                          ...
                                          <p className="text-sm text-muted-foreground">
                                              Time between particle emissions in
                                              milliseconds.
                                          </p>
                                      </div>
                                  </div>
                                  <div className="border rounded-xl p-4 bg-[#171717] backdrop-blur-sm border-purple-400 shadow-md">
                                      ...
                                      <p className="text-sm text-muted-foreground">
                                          Minimum cursor movement distance to
